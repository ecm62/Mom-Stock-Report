...
with st.sidebar:
    ...
    st.markdown(f"目前使用者：**{current_user}**")
    st.divider()

    st.header("⚙️ 股票管理")
    # 傳入 user 參數，確保加到對應的人名下
...
with c_title:
    st.title(f"👵 {current_user} 的股海顧問") # 標題會隨名字改變
